var preguntas = [
    "¿Qué país ha ganado más juegos olímpicos?",
    "¿qué país tiene mayor población 2021?",
    "¿Qué país es el más rico del mundo?"
    ];
    var opciones = [[
      "Alemania",
      "Noruega",
    ...
    function mostrarResultado() {
      ...
      var div = document.getElementsByClassName("paises")[0];
      div.innerHTML = "";
